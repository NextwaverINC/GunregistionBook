...
namespace GRB.Console.Expired
{
    class Expired
    {
        ...
        public void Start()
        {
            ...
            DataTable dt = GRBS.getExpiredBook();
            ...
            for (int i = 0; i < dt.Rows.Count; i++)
            {
                ...
                AddDataXmlNode(RootPathBook + "/Item[@Name='BookStatus']", "Expired");
                ...
                NCS.Add(new NextwaverDB.NColumn("BOOKSTATUS", "Expired"));
                ...
                try
                {
                    ...
                    GRB_ws.MoveToFolderByID(int.Parse(ID), "Expired");
                }
